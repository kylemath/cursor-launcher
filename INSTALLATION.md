...
alias projects='cd ~/Coding/TOOLS/cursor-launcher && ./launch.sh'
```
...
3. Paste:
   ```bash
   ~/Coding/TOOLS/cursor-launcher/launch.sh
   ```
...
```bash
0 9 * * * cd ~/Coding/TOOLS/cursor-launcher && python3 generate_dashboard.py
```
...
<dict>
    ...
    <array>
        ...
        <string>~/Coding/TOOLS/cursor-launcher/generate_dashboard.py</string>
    </array>
