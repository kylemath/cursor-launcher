...
- **Static dashboard generator** scanning `~/Coding/`
...
def discover_repo_with_origin(path):
    ...
    return {
        ...
        "github_repo": "kylemath/repo-name",  # or None
...
// sync/machines/macbook-pro.json
{
  ...
  "repos": {
    "kylemath/cursor-launcher": {
      "local_path": "~/Coding/TOOLS/cursor-launcher",
      "last_opened": "2026-02-02T15:25:00Z",
      "last_pushed": "2026-02-02T14:00:00Z"
    },
    "kylemath/other-project": {
      "local_path": "~/Coding/RESEARCH/other-project",
